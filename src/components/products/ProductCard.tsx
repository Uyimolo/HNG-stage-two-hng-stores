...
const ProductCard = ({ product }: { product: Product }) => {
  return (
    <div className='bg-white rounded-[5px] overflow-hidden group  border border-gray shadow-md lg:rounded-[12px]'>
      {/* product image */}
      <div className=' aspect-square overflow-hidden w-full  rounded-[5px] relative lg:rounded-[12px]'>
        <img
          src={product.image}
          alt=''
      ...
      {/* product information */}
      <div className='py-1 px-[6px] space-y-2 shadow-md lg:py-3 lg:px-3'>
        ...
        <div className='h-6 md:h-6 lg:h-10'>
          <Button
            variant='primary'
            className=' min-w-full h-6 hidden group-hover:block md:h-6 lg:min-w-full lg:h-10'>
            ADD TO CART
          </Button>
        </div>
      </div>
